...
//o estoque de determinado produto em uma loja qualquer. Considere que a quantidade 
//mínima de um produto deva ser 10. Se o estoque for menor que isso, então ele retornará *true*, 
//pois, será necessária a reposição do estoque, caso contrário, ele retornará false.

//Como parâmetro, esse método deverá receber um tipo que você irá criar e chamar de Produto, 
//ou seja, você vai criar uma classe chamada Produto com os atributos necessários. 
...
//variável do tipo Produto e depois usar essa variável para invocar o método que valida a 
